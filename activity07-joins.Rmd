...
**Response**: Yes there are locations of La Quinta's outside of the US. I did not see any Denny's locations outside of the US.
...
**Response**: Find all rows of data that do not have a state code within the United States.
...
**Response**: There are not any Dennys locations outside of the US.
...
**Response**:Maine, Arkansas and New Hampshire have the fewest La Quinta locations.
...
dennys %>% 
  ...
  mutate(loc_per_thou_miles = round((locations / area), 4)) %>% 
  arrange(desc(loc_per_thou_miles)) %>% 
  select(state, name, locations, loc_per_thou_miles)
...
**Response**: District of Columbia, Rhode Island, and California have the most Denny's locations per thousand square miles. 
